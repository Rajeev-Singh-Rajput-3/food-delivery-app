    ...
    <div className='w-full h-[120px] p-2 shadow-lg flex justify-between'>
      <div className='w-[60%] h-full flex gap-5'>
        ...
        <div className='w-[40%] h-full flex flex-col gap-3'>
            ...
            <div className='w-[110px] h-[50px] bg-slate-400 flex rounded-lg overflow-hidden shadow-lg text-xl text-green-400 border-2 border-green-400 font-semibold'>
                <button className='w-[30%] h-full bg-white flex justify-center items-center hover:bg-gray-100' onClick={() => {
